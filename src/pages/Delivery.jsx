...
const SAMPLE_ASSETS = {
  video: {
    path: DEMO_ASSETS.video.url,
    filename: DEMO_ASSETS.video.filename,
    size: DEMO_ASSETS.video.size,
    meta: DEMO_ASSETS.video.meta,
  },
  ppt: {
    path: DEMO_ASSETS.ppt.url,
    filename: DEMO_ASSETS.ppt.filename,
    size: DEMO_ASSETS.ppt.size,
    meta: DEMO_ASSETS.ppt.meta,
  },
  poster: {
    path: DEMO_ASSETS.poster.url,
    filename: DEMO_ASSETS.poster.filename,
    size: DEMO_ASSETS.poster.size,
    meta: DEMO_ASSETS.poster.meta,
  },
};
